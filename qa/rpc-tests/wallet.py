...
#   c) node1 mines 61 blocks, so now nodes 0 and 1 have 500.000 darx, node2 has none. 
#   d) node0 sends 210.000 darx to node2, in two transactions (110.000 darx, then 100.000 darx).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210.000 DARX from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1.000.000 darx in block rewards plus fees, but
        ...
        # Send 100000 DARX with subtract fee from amount
