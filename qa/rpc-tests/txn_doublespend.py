...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 7,500,000 DARX:
        ...
        # First: use raw transaction API to send 7499960 DARX to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 500,000 DARX for another
        ...
        # Node0's total balance should be starting balance, plus 1,000,000 DARX for 
