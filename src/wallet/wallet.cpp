        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // BitDaric: Disable free transactions
...
{
    // BitDaric: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // BitDaric: Add an increased fee for each dust output
        nFeeNeeded += GetBitDaricDustFee(tx.vout, minTxFee);
    }
