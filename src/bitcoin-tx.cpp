...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BitDaric Core bitdaric-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitdaric-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitdaric transaction") + "\n" +
              "  bitdaric-tx [options] -create [commands]   " + _("Create hex-encoded bitdaric transaction") + "\n" +
              "\n";
