...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("BitDaric Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  bitdaric-cli [options] <command> [params]  " + _("Send command to BitDaric Core") + "\n" +
                  "  bitdaric-cli [options] help                " + _("List commands") + "\n" +
                  "  bitdaric-cli [options] help <command>      " + _("Get help for a command") + "\n";
