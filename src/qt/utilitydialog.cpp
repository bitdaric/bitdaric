    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitDaric Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About BitDaric Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitdaric-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitDaric Core is shutting down...") + "<br /><br />" +
