    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitDaric Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // BitDaric: load fallback font in case Comic Sans is not availble on the system
    /*
    ...
    // BitDaric: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // BitDaric: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitDaric address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitdaric: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About BitDaric Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitDaric Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for BitDaric Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitDaric addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitDaric addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BitDaric Core help message to get a list with possible BitDaric command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitDaric Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitDaric network", "", count));
}
...
{
    QString strTitle = tr("BitDaric"); // default title
