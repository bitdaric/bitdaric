...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBTC: return QString("MDARX");
    case kBTC: return QString("kDARX");
    case BTC: return QString("DARX");
    case mBTC: return QString("mDARX");
    case uBTC: return QChar(0x03BC) + QString("DARX");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBTC: return tr("Mega-BitDarics (1,000,000)");
    case kBTC: return tr("Kilo-BitDarics (1,000)");
    case BTC: return tr("BitDarics");
    case mBTC: return tr("Milli-BitDarics (1 / 1,000)");
    case uBTC: return tr("Micro-BitDarics (1 / 1,000,000)");
    default: return QString("???");
    }
}
